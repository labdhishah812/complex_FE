...
import { createPropertyRequest, createPropertyRequestforSelfInquiry } from '../../../../redux/slice/AdminSlices/complexSlice';
import { fetchPincodeRequest } from '../../../../redux/slice/AdminSlices/propertySlice';
import axios from 'axios';
import ComplexLogo from '../../../../assets/images/Complex360-02.svg';

const SelfInquiryForm = () => {
    ...
    return (
        <div className="relative min-h-full">
            ...
            >
                <div>
                    <img
                        ...
                        src={ComplexLogo}
                        alt="Complex360 Logo"
                        style={{ height: '2rem' }} // Matches `h-8` in Tailwind
                    />
                </div>
            </header>
            ...
            <div className="crud-demo ml-0 mr-0 card mt-3">
                <Formik
                    ...
                    onSubmit={(values) => {
                        ...
                        formData.append('subscriptionPlan', values?.subscriptionPlan ? values?.subscriptionPlan : 'Basic');
                        formData.append('subscriptionStatus', values?.subscriptionStatus ? values?.subscriptionStatus : 'Active');
                        formData.append('billingCycle', values?.billingCycle ? values?.billingCycle : 'Monthly');
                        ...
                        dispatch(createPropertyRequestforSelfInquiry(formData));
            ...
            {errors.billingCycle && touched.billingCycle && 'Please select a Billing Cycle.'}
                                ...
                                <div className="grid p-fluid mt-3">
                                    <div className="field col-12 md:col-12 mb-1">
                                        <div className="flex justify-content-end">
                                            {/* <Button type="button" label="Cancel" className="p-button-outlined p-button-danger mr-2 mb-2 w-7rem" onClick={() => navigate('/selfinquiry/form')} /> */}
                                            <Button
                                                label="Save"
                                                type="submit"
                                                ...
                                                onClick={(e) => {
                                                    if (!isOtpVerified) {
                                                        e.preventDefault(); // Form submission ko rokena
                                                        alert('Please verify your email first and then save your property');
                                                    } else {
                                                        e.preventDefault(); // Form submission ko handle karna
                                                        setShowDialog(true); // Popup dikhana
                                                    }
                                                }}
                                            />
                                        </div>
                            ...
                            <Dialog
                                header={<h2 className="text-teal-600">Success!</h2>}
                                visible={showDialog}
                                ...
                                footer={
                                    <div className="flex justify-content-center">
                                        <Button label="OK" icon="pi pi-check" className="p-button-success p-button-rounded" onClick={handleDialogClose} />
                                    </div>
                                }
                            >
                                <div className="text-center">
                                    ...
                                    <p className="text-lg">
                                        Your property has been saved successfully. It will be activated within <strong>24 hours</strong>.
                                    </p>
                                </div>
                            </Dialog>
                        </Form>
...
export default SelfInquiryForm;
