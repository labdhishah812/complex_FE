...
import { getRoleDropDownRequest, userCommitteeCreateRequest, updateCommitteeRequest, getCommitteeDataByid } from '../../../../redux/slice/AdminSlices/committeeSlice';
const CommitteeCreate = () => {
    ...
    const breadcrumbItems = [
        {
            label: params?.id ? 'Edit Core Member' : 'Add Core Member'
        }
    ];
    useEffect(() => {
    ...
    return (<div className="relative min-h-full">
        ...
        <div className="flex justify-content-between align-items-center">
            <div className="flex flex-row w-full">
                <h5 className="title m-2 pr-3 flex align-items-center justify-content-center">{params?.id ? 'Edit Core Member' : 'Add Core Member'}</h5>
                        ...
                        <div className="grid p-fluid mt-1">
                            <div className="field col-12 md:col-12 mb-1 flex justify-content-end">
                                <Button label="Cancel" icon="pi pi-times" className="p-button-outlined p-button-danger mr-2 mb-2 w-7rem"
                                    // onClick={onHide} 
                                    onClick={() => navigate('/property-management/committee')}
                                />
                                <Button
                                    disabled={submitted}
