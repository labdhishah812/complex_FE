...
const RolesList = () => {
        ...
        return (
            <React.Fragment>
                <Button
                    ...
                    onClick={() => {
                        navigate('/property-management/role-create');
                        // setModal(true);
                        // steEdit(null);
                    }}
                />
    ...
    const leftToolbarTemplate = () => {
        const isSearchDisabled = rolesData?.data?.role_listing.length === 0 && pagination?.search === '';
        return (
            <React.Fragment>
                <div className="flex justify-content-end w-27rem">
                    <span className="p-input-icon-right">
                        ...
                        <InputText
                            placeholder="Search by Roles, Description"
        ...
        return (
            <div className="actions flex justify-content-center">
                 <Button
                    ...
                    id="eyes-icons"
                    onClick={() => {
                        navigate(`/property-management/roles/role-view/${rowData._id}`);
                    }}
                />
                <Button
                    tooltip="Edit"
                    ...
                    onClick={() => {
                        navigate(`/property-management/role-edite/${rowData._id}`);
                        // setModal(true);
                        // steEdit(rowData);
                    }}
                    disabled={rowData.role === 'Chairman' || rowData.role === 'User'}
                />
    ...
    const descriptionTemplate = (rowData) => {
        return <div className="ml-2 capitalize-first-letter">{rowData.description ? rowData.description : '-'}</div>;
    };
    // console.log(rolesData, 'getRolesData');
    return (
        <div className="relative min-h-full">
            <Loader isLoading={isLoading} />
            <div className="flex justify-content-between align-items-center">
                <div className="flex flex-row w-full">
                    <h5 className="title m-2 pr-3 flex align-items-center justify-content-center">Roles</h5>
            ...
            <div className="grid crud-demo ml-0 mr-0">
                <div className="col-12 card mt-2">
                    {rolesData?.data?.role_listing && rolesData?.data?.role_listing.length > 0 ? (
                        ...
                        >
                            <Column field="role" className='h-50' header="Roles" sortable></Column>
                            <Column body={descriptionTemplate} field="description" header="Description" className='capitalize-first-letter' sortable></Column>
