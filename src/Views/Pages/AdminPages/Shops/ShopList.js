...
const ShopList = () => {
    ...
    const handleUpdate = () => {
        ...
        dispatch(editShopRequest(value?._id, formData));
    };
    ...
    const rightToolbarTemplate = () => {
        return (
            <React.Fragment>
                <Button label="Shop Create " icon="pi pi-plus" className="p-button-outlined p-button-success mr-2 "
        ...
        <>
            <div className="flex justify-content-between align-items-center">
                <div className='flex flex-row'>
                    <h5 className='title border-right-2 m-2 pr-3 border-yellow-500 flex align-items-center justify-content-center'>Shop List</h5>
            ...
            <div className="grid crud-demo ml-0 mr-0">
                <div className="col-12 card mt-2">
                    ...
                    <Dialog visible={modal?.isModalOpen} style={{ width: '60vw' }} header="Shop Create" modal className="p-fluid" footer={userCreateDialogFooter} onHide={hideDialog}>
                    ...
                    <Dialog visible={modal.isEditModalOpen} style={{ width: '60vw' }} header="Shop Update" modal className="p-fluid usercreation" footer={updateUserDialogFooter} onHide={hideDialog}>
                        <div className="grid p-fluid mt-1">
                            <div className="field col-12 md:col-6 mb-1">
                                <label htmlFor="society_name" className="required">
                                    Society Name
                    ...
                    <Dialog visible={modal.isViewModalOpen} style={{ width: '60vw' }} header="Shop Details" modal className="p-fluid usercreation viewmodel" onHide={hideDialog}>
                        <div className="grid p-fluid mt-1">
                            <div className="field col-12 md:col-6 mb-1">
